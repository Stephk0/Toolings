bl_info = {
    ...
    "description": "Export collections with auto-move empties to origin feature",
...
class MASSEXPORTER_OT_export_all(Operator):
    """Export all enabled collections with auto-move empties to origin"""
    bl_idname = "massexporter.export_all"
    bl_label = "Export All"
    bl_description = "Export all enabled collections with auto-move empties to origin"
    ...
    def export_children_combined(self, context, props, empty, children, export_path):
        ...
        if props.debug_mode:
            print(f"Combining children of {empty_name}")
...
class MASSEXPORTER_PT_main_panel(Panel):
    ...
    def draw(self, context):
        ...
        # Empty centering controls section
        ...
        centering_box.label(text="Moves empties with children to (0,0,0)")
        ...
        if props.collection_items and len(props.collection_items) > props.active_collection_index:
            ...
            if active_item.use_empty_origins:
                ...
                if active_item.move_empties_to_origin_on_export:
                    ...
                    info_box.label(text="before export, then restore positions")
