bl_info = {
    "name": "Mass Collection Exporter - FINAL VERSION",
    "author": "Claude AI", 
    "version": (5, 2, 0),
    "blender": (3, 0, 0),
    "location": "3D View > N-Panel > Mass Exporter",
    "description": "Export collections with working empty centering - Collection-specific centering",
...
class MASSEXPORTER_PT_main_panel(Panel):
    ...
    bl_label = "Mass Exporter - FINAL VERSION"
    ...
    def draw(self, context):
        ...
        status_box.label(text="FINAL: Collection-specific centering", icon='CHECKMARK')
        status_box.label(text="Export uses same centering method")
    ...
    def draw(self, context):
        ...
        if props.collection_items and len(props.collection_items) > props.active_collection_index:
            ...
            if active_item.use_empty_origins:
                ...
                # Add note about collection-specific centering
                note_box = box.box()
                note_box.label(text="FINAL: Collection-specific centering", icon='CHECKMARK')
                note_box.label(text="Only moves empties from enabled collections")
