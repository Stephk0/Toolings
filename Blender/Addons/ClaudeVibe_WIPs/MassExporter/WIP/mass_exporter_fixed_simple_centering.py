bl_info = {
    "name": "Mass Collection Exporter Fixed - Simple Centering",
    "author": "Claude AI", 
    "version": (4, 7, 0),
    "blender": (3, 0, 0),
    "location": "3D View > N-Panel > Mass Exporter",
    "description": "Export collections with SIMPLE and RELIABLE empty centering",
...
class MASSEXPORTER_PT_main_panel(Panel):
    ...
    bl_label = "Mass Exporter Fixed - Simple Centering"
    ...
    def draw(self, context):
        ...
        if props.collection_items and len(props.collection_items) > props.active_collection_index:
            ...
            if active_item.use_empty_origins:
                ...
                note_box = box.box()
                note_box.label(text="Fixed: Simple & Reliable Centering", icon='INFO')
                note_box.label(text="Direct location setting like empty_center_tool.py")
