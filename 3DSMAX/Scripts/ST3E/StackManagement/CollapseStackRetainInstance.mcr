macroScript CollapseStackRetainInstance
	...
	(
		...
		-----------------------------------------------------------------------
		-- to retain instance you have to right click onto the modifer and choose collapse To ob object by object. This script helps to do this on multiple objects
		-----------------------------------------------------------------------
